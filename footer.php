    ...
    <div class="wrapper">
        <div class="grid grid-cols-2 gap-4 py-10 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7">
            <div
                ...
                alt="Locksmith Logo"
              /> -->
                    <h2 class="flex-1 flex flex-col text-xl text-start font-bold leading-none lg:text-2xl">
                    ...
                    <div class="flex flex-col gap-2 xs:flex-row">
                        <div class="flex items-center gap-2.5 xs:w-1/2">
                            ...
                            <a href="tel:01125125125"
                                class="text-gray-400 transition-all duration-200 hover:text-orangeColor">01125 125
                                125</a>
                        </div>
                        ...
                        <div class="flex items-center gap-2.5 xs:w-1/2">
                            ...
                            <a href="mailto:info@locksmith.com"
                                class="text-gray-400 transition-all duration-200 hover:text-orangeColor">info@locksmith.com</a>
                        </div>
                    </div>
            ...
            <ul class="flex flex-col gap-1">
                ...
                <li>
                    <a href="#" class="text-gray-400 transition-all duration-200 hover:text-orangeColor">Home</a>
                </li>
                <li>
                    <a href="#about" class="text-gray-400 transition-all duration-200 hover:text-orangeColor">About</a>
                </li>
                <li>
                    <a href="#services"
                        class="text-gray-400 transition-all duration-200 hover:text-orangeColor">Services</a>
                </li>
                <li>
                    <a href="#location"
                        class="text-gray-400 transition-all duration-200 hover:text-orangeColor">Locations</a>
                </li>
                <li>
                    <a href="#contact"
                        class="text-gray-400 transition-all duration-200 hover:text-orangeColor">Contact</a>
                </li>
            </ul>
                  ...
                  foreach ($services as $service) : ?>
                    <li>
                        <a href="<?php echo esc_url($service['link']); ?>"
                            class="text-gray-400 transition-all duration-200 hover:text-orangeColor"><?php echo esc_html($service['title']); ?></a>
                    </li>
        ...
        <div
            ...
            <ul class="flex items-center gap-4 text-sm">
                <li>
                    <a href="#" class="text-gray-400 transition-all duration-200 hover:text-orangeColor">Privacy
                        Policy</a>
                </li>
                <li>
                    <a href="#" class="text-gray-400 transition-all duration-200 hover:text-orangeColor">Terms of
                        Use</a>
                </li>
                <li>
                    <a href="#" class="text-gray-400 transition-all duration-200 hover:text-orangeColor">Sitemap</a>
                </li>
            </ul>
        </div>
    </div>
